...
- **Phase 1 — Screens visuell umstellen** (Token-Klassen + Basis-Komponenten statt roher Klassen). Reihenfolge: **Einstellungen ✅** → **Verwaltung ✅** → **Ruhmeshalle ✅** → **Home ✅** (alle 2026-07-24) → **offen: Login/Register/Passwort-Flows**.
