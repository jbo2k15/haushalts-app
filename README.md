...
- **Navigation** — Bottom-Navigation (unten) mit direktem Zugriff auf Aufgaben, Ruhmeshalle, Einstellungen und (für Admins) Verwaltung; zwischen Aufgaben und Ruhmeshalle zusätzlich per Wisch-Geste (links/rechts, Touch oder Maus). Der Browser-/System-Zurück-Pfeil verlässt Einstellungen/Verwaltung zuverlässig, auf der Startseite fragt er erst nach, ob die App wirklich geschlossen werden soll (abschaltbar)
