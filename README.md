...
- **Navigation** — Zwei konstante Wege: Wischen zwischen Startseite und Ruhmeshalle sowie ein einheitliches Menü (oben rechts) mit direktem Zugriff auf Aufgabenübersicht, Einstellungen, Ruhmeshalle und (für Admins) Verwaltung; der Browser-/System-Zurück-Pfeil verlässt Einstellungen/Verwaltung zuverlässig, auf der Startseite fragt er erst nach, ob die App wirklich geschlossen werden soll (abschaltbar)
