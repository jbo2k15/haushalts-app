...
test('multi-completion weekly task can be completed several times and undone one at a time', async ({ page }) => {
  const errors = attachErrorCollector(page)
  await login(page)

  const row = page.locator('[data-testid="task-row"][data-task-title="E2E Weekly Multi Task"]')
