...
export const EMPTY_FORM = { title: '', type: 'daily', priority: 'normal', weekdays: [], fixedWeekday: '', fixedDayOfMonth: '', monthlyInterval: 1, dueDate: '', isActive: true, allowMultiple: false, weatherDependent: false, pauseFrom: '', pauseTo: '' }
