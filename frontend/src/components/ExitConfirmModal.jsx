...
export default function ExitConfirmModal({ onCancel, onConfirm }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4" onClick={onCancel} data-testid="exit-confirm-modal">
      <div className="bg-white dark:bg-gray-800 rounded-2xl w-full max-w-sm p-4 space-y-4" onClick={e => e.stopPropagation()}>
        <div>
          <h2 className="text-sm font-semibold text-gray-800 dark:text-gray-200">App schließen?</h2>
